...
Page({
        ...
        ctx.draw(true, () => {
            ...
            wx.canvasToTempFilePath({
                ...
                success: function (res) {
                    // wx.hideLoading()
                    // 成功获得地址的地方
                    getApp().upload("about/ocr", res.tempFilePath, (data) => {
                        wx.hideLoading()
                        try {
                            getApp().params =  JSON.parse(data)["data"]
                            //wx.hideLoading()
                            wx.navigateBack({
                                delta: 1
                            })
    ...
    getOriginalImageInfo() {
        ...
        getApp().upload("about/ocr", this.data.imageSrc , (data) => {
            wx.hideLoading()
            try {
                getApp().params =  JSON.parse(data)["data"]
                //wx.hideLoading()
